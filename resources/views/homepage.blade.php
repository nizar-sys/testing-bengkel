...
<head>
    ...
    <title>Searching Repair - Homepage</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Cari Bengkel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Haversine</a>
              </li>     
              <a href="#" class="btn btn-master btn-primary ms-3">
                Login
              </a>
            </ul>
          </div>
